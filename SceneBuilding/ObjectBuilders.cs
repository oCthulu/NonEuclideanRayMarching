...
public class Union : FunctionObjectBuilder<Union>{
    ...
    public override string GetSdfExpression(SourceBuilder sb) => Util.GetBinaryFunctionNest<ObjectBuilder>("UnionSdf", objects.ToArray(), o => o.BuildSdfSource(sb));
    public override string GetHitExpression(SourceBuilder sb) => Util.GetBinaryFunctionNest<ObjectBuilder>("UnionHit", objects.ToArray(), o => o.BuildHitSource(sb));
}

public class SmoothUnion : FunctionObjectBuilder<SmoothUnion>{
    List<ObjectBuilder> objects = new List<ObjectBuilder>();
...
public class Intersection : FunctionObjectBuilder<Intersection>{
    List<ObjectBuilder> objects = new List<ObjectBuilder>();
...
public class Invert : FunctionObjectBuilder<Invert>{
    ObjectBuilder obj;
...
public class Sphere : FunctionObjectBuilder<Sphere>{
...
public class Plane : FunctionObjectBuilder<Plane>{
